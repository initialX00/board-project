        ...
        <div css={s.container}>
            ...
            <div>
                <div css={s.itemGroup}>
                    ...
                    <button css={s.boarderButton} onClick={() => api.post("/api/auth/email", {email: "rkdlswlsdn@naver.com"})}>Change email</button>
                </div>
                <div css={s.itemGroup}>
                    <div>
                    ...
                    <button css={s.boarderButton} onClick={handleChangePasswordButtonOnClick}>Change password</button>
                </div>
            </div>
            <ReactModal
